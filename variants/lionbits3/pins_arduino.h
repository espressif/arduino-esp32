...
/* Hardware HSPI */
static const uint8_t MOSI = 3; // GPIO3;
static const uint8_t MISO = 4; // GPIO4;
static const uint8_t SCK = 5;  // GPIO5;
static const uint8_t SS = 6;   // GPIO6;
//---------------------------------- 

static const uint8_t TFT_RST = 38;  //GPIO38;     // - RESET GPIO33, XTAL_32K_N (32.768 kHz crystal oscillator output),ADC1_CH5, TOUCH8, RTC_GPIO8
static const uint8_t TFT_SCLK = 35;  //GPIO35;    // - (18) CLK  (D11) and  D9 pin will engaged when display "ON or USE"
static const uint8_t TFT_CS = 42;   //GPIO42;      // - CS    GPIO27, ADC2_CH7, TOUCH7, RTC_GPIO17, EMAC_RX_DV
static const uint8_t TFT_DC = 37;   //GPIO37; DC/A0 GPIO32, XTAL_32K_P (32.768 kHz crystal oscillator input), ADC1_CH4,TOUCH9, RTC_GPIO9
static const uint8_t TFT_MOSI = 36;  //GPIO36; // - MOSI (D9) This D9 pin will engaged when display "ON or USE"

static const uint8_t LCD_A0 = 37;
static const uint8_t LCD_BACK_LIGHT = 45;
static const uint8_t DAC1 = 21; // I/O GPIO21, 
//LCD aditional pins
