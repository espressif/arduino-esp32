...
static const int8_t       INPUT_IOTYPE[]      = { FTSWARM_HAL_IO_DIGITAL, FTSWARM_HAL_IO_DIGITAL, FTSWARM_HAL_IO_DIGITAL, FTSWARM_HAL_IO_DIGITAL, FTSWARM_HAL_IO_DIGITAL, FTSWARM_HAL_IO_DIGITAL, FTSWARM_HAL_IO_DIGITAL, FTSWARM_HAL_IO_DIGITAL };
...
static const int8_t       MOTOR_IOTYPE[]  = { FTSWARM_HAL_IO_MOTOR, FTSWARM_HAL_IO_MOTOR, FTSWARM_HAL_IO_MOTOR, FTSWARM_HAL_IO_MOTOR, FTSWARM_HAL_IO_MOTOR, FTSWARM_HAL_IO_MOTOR, FTSWARM_HAL_IO_MOTOR, FTSWARM_HAL_IO_MOTOR };
