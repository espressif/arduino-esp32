...
2. **Type**
    ...
    * ``app`` (0x00) type is used to define the partition that will store the application.

    * ``data`` (0x01) type can be used to define the partition that stores general data, not the application.
