...
-|:-:|:-:|:-:|:-:|:-:|:-:|:-:
gpio|1/1 :white_check_mark:|1/1 :white_check_mark:|0/1 :x:|0/1 :x:|1/1 :white_check_mark:|1/1 :white_check_mark:|1/1 :white_check_mark:
...
Generated on: 2025/11/28 00:38:52

[Commit](https://github.com/espressif/arduino-esp32/commit/e7df08a65241930b188a48ffa0cac9551029db6a) / [Build and QEMU run](https://github.com/espressif/arduino-esp32/actions/runs/19750407803) / [Hardware and Wokwi run](https://github.com/espressif/arduino-esp32/actions/runs/19750503404) / [Results processing](https://github.com/espressif/arduino-esp32/actions/runs/19750792887)

[Test results](https://github.com/espressif/arduino-esp32/runs/56593407622)
