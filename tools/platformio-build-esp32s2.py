...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32s2", "include", "esp_diag_data_store", "src", "rtc_store"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32s2", "include", "esp_diag_data_store", "include"),
    ...
    CPPDEFINES=[
        ...
        "WITH_POSIX",
        "_GNU_SOURCE",
        ("IDF_VER", '\\"v4.4.4-448-gfd5e03b221\\"'),
        "ESP_PLATFORM",
