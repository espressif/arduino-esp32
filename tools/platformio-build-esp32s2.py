...
env.Append(
    ...
    CPPDEFINES=[
        ...
        "WITH_POSIX",
        "_GNU_SOURCE",
        ("IDF_VER", '\\"v4.4.3-357-g800dec96e9\\"'),
        "ESP_PLATFORM",
