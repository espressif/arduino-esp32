...
env.Append(
    ...
    LIBS=[
        "-lgcc", "-lspiffs", "-lface_recognition", "-lunity", "-llog", "-lnvs_flash", "-ltcp_transport", "-lesp-tls", "-lxtensa-debug-module", "-lnghttp", "-lfreertos", "-lmbedtls", "-lhal", "-ldetection", "-lbootloader_support", "-ldetection_cat_face", "-lasio", "-lwps", "-lespcoredump", "-lsdmmc", "-lesp_ringbuf", "-llibsodium", "-limage_util", "-lfb_gfx", "-lwpa2", "-lesp_http_server", "-ltcpip_adapter", "-lesp32-camera", "-lfd", "-lesp_http_client", "-lexpat", "-lvfs", "-lcxx", "-ljsmn", "-lwear_levelling", "-lpe", "-lmicro-ecc", "-lspi_flash", "-lapp_update", "-lfr", "-ldriver", "-lrtc", "-ldl", "-lpthread", "-lefuse", "-lod", "-lapp_trace", "-lsmartconfig_ack", "-lcoap", "-lesp_event", "-lc_nano", "-lcoexist", "-lpp", "-lfatfs", "-lethernet", "-lwpa", "-lsmartconfig", "-lbtdm_app", "-lbt", "-lespnow", "-lopenssl", "-ljson", "-lcore", "-lmesh", "-lsoc", "-lprotocomm", "-lconsole", "-lface_detection", "-lphy", "-lesp_https_ota", "-llwip", "-lesp_adc_cal", "-lulp", "-lnet80211", "-lnewlib", "-lesp_https_server", "-lc", "-lfreemodbus", "-lesp_websocket_client", "-lm", "-lheap", "-lwpa_supplicant", "-lesp32", "-lmdns", "-lwifi_provisioning", "-lmqtt", "-lprotobuf-c", "-lstdc++"
    ],
