...
env.Append(
    ...
    LIBS=[
        "-lgcc", "-lrtc", "-lxtensa-debug-module", "-lvfs", "-lwpa", "-lc_nano", "-lmbedtls", "-lopenssl", "-lnvs_flash", "-lhuman_face_detect", "-lunity", "-lconsole", "-ljson", "-lspi_flash", "-lm", "-lexpat", "-lesp_adc_cal", "-lesp_https_ota", "-lfreertos", "-llog", "-lbt", "-llibsodium", "-lmicro-ecc", "-lesp_http_server", "-lwifi_provisioning", "-lesp32-camera", "-lespnow", "-lprotocomm", "-lbootloader_support", "-lmdns", "-lesp_https_server", "-ldriver", "-lcoexist", "-lwpa2", "-lespcoredump", "-lmfn", "-lc", "-lsoc", "-lcxx", "-ldl", "-lpthread", "-lfatfs", "-lprotobuf-c", "-lapp_update", "-lulp", "-lfb_gfx", "-ltcpip_adapter", "-lsmartconfig_ack", "-lapp_trace", "-lfreemodbus", "-lsdmmc", "-lhal", "-lesp_event", "-lesp32", "-lphy", "-lnet80211", "-lnghttp", "-lnewlib", "-lwps", "-lesp-tls", "-lesp_http_client", "-lmesh", "-lwpa_supplicant", "-lpp", "-ljsmn", "-lcoap", "-lcore", "-lwear_levelling", "-lcat_face_detect", "-lbtdm_app", "-llwip", "-ltcp_transport", "-lspiffs", "-lasio", "-lesp_ringbuf", "-lethernet", "-lheap", "-lesp_websocket_client", "-lsmartconfig", "-lmqtt", "-lefuse", "-lstdc++"
    ],
