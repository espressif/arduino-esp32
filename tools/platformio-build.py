...
env.Append(
    ...
    LIBS=[
        "-lgcc", "-lopenssl", "-lbtdm_app", "-lfatfs", "-lcoexist", "-lwear_levelling", "-lesp_http_client", "-lprotobuf-c", "-lhal", "-lnewlib", "-lxtensa", "-ldriver", "-lbootloader_support", "-lpp", "-lfreemodbus", "-lmesh", "-lsmartconfig", "-ljsmn", "-lesp_gdbstub", "-lphy", "-lesp_local_ctrl", "-lapp_trace", "-lconsole", "-lulp", "-lwpa_supplicant", "-lfreertos", "-lbt", "-lesp32-camera", "-lcxx", "-ltcp_transport", "-lod", "-lmdns", "-lvfs", "-lesp_websocket_client", "-lespcoredump", "-lesp_wifi", "-lesp_ringbuf", "-lsoc", "-lcore", "-lfb_gfx", "-lsdmmc", "-llibsodium", "-lcoap", "-ltcpip_adapter", "-lprotocomm", "-lesp_event", "-limage_util", "-lesp-tls", "-lasio", "-lrtc", "-lesp_eth", "-lesp_common", "-lspi_flash", "-lwifi_provisioning", "-lesp32", "-lface_recognition", "-lapp_update", "-lesp_rom", "-lnghttp", "-lspiffs", "-lface_detection", "-lefuse", "-lunity", "-lespnow", "-lnvs_flash", "-lesp_adc_cal", "-llog", "-ldl_lib", "-lexpat", "-lm", "-lfr", "-lmqtt", "-lheap", "-lmbedtls", "-llwip", "-lnet80211", "-lesp_http_server", "-lpthread", "-ljson", "-lesp_https_ota", "-lfd", "-lc", "-lstdc++"
    ],
