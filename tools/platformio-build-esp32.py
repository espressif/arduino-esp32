...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "freertos", "FreeRTOS-Kernel", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "freertos", "FreeRTOS-Kernel", "portable", "xtensa", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "freertos", "esp_additions", "include", "freertos"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "freertos", "esp_additions", "include"),
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "esp_system", "port", "include", "private"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "xtensa", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "xtensa", "esp32", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "lwip", "include"),
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "lwip", "port", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "lwip", "port", "freertos", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "lwip", "port", "esp32xx", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "lwip", "port", "esp32xx", "include", "arch"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "espressif__mdns", "include"),
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "deprecated"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "dac", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "gpio", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "gptimer", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "i2c", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "i2s", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "ledc", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "mcpwm", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "pcnt", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "rmt", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "sdio_slave", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "sdmmc", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "sigma_delta", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "spi", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "temperature_sensor", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "touch_sensor", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "twai", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "uart", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "usb_serial_jtag", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "driver", "touch_sensor", "esp32", "include"),
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "mbedtls", "mbedtls", "library"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "mbedtls", "esp_crt_bundle", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "esp_app_format", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "bootloader_support", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "bootloader_support", "bootloader_flash", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "esp_partition", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "app_update", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "esp_mm", "include"),
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "bt", "porting", "ext", "tinycrypt", "include"),
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "http_parser"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "esp-tls"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "esp-tls", "esp-tls-crypto"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "esp_adc", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "esp_adc", "interface"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "esp_adc", "esp32", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "esp_adc", "deprecated", "include"),
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "esp_psram", "include"),
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "ulp", "ulp_common", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "ulp", "ulp_common", "include", "esp32"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "ulp", "ulp_fsm", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32", "include", "ulp", "ulp_fsm", "include", "esp32"),
