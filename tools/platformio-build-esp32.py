...
env.Append(
    ...
    CPPDEFINES=[
        ...
        "WITH_POSIX",
        "_GNU_SOURCE",
        ("IDF_VER", '\\"v4.3-dev-1472-g0b71a0a46-dirty\\"'),
        "ESP_PLATFORM",
        "ARDUINO_ARCH_ESP32",
        "ESP32",
        ("F_CPU", "$BOARD_F_CPU"),
