...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "lwip", "port", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "lwip", "port", "freertos", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "lwip", "port", "esp32xx", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "lwip", "port", "esp32xx", "include", "arch"),
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "dac", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "gpio", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "gptimer", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "i2c", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "i2s", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "ledc", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "mcpwm", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "pcnt", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "rmt", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "sdio_slave", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "sdmmc", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "sigma_delta", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "spi", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "temperature_sensor", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "touch_sensor", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "twai", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "uart", "include"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "driver", "usb_serial_jtag", "include"),
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "esp_mm", "include"),
