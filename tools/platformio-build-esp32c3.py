...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "esp_diag_data_store", "src", "rtc_store"),
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "esp_diag_data_store", "include"),
