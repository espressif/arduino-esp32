/*
  ...
  Modified Sep 2021 by Rodrigo Garcia Corbera (rocorbera@gmail.com) - Full ESP-IDF based refactoring
*/
...
public:
    ...
    bool setSDA(int sdaPin);
    bool setSCL(int sclPin);
    
    bool begin(int sda=-1, int scl=-1, uint32_t frequency=0);

    // setClock shall be set before begin()
...
/*
V2.0.1 10SEP2021 new version - I2C IDF based refactoring 
