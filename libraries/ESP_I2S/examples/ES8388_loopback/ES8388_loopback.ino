...
/* I2C */
const uint8_t I2C_PIN_SCL = 23;
const uint8_t I2C_PIN_SDA = 18;
const uint32_t I2C_FREQ = 400000;

/* I2S */
const uint8_t I2S_PIN_MCLK = 0;   /* Master clock */
const uint8_t I2S_PIN_SCK = 5;    /* Audio data bit clock */
const uint8_t I2S_PIN_WS = 25;    /* Audio data left and right clock */
const uint8_t I2S_PIN_SDOUT = 26; /* ESP32 audio data output (to speakers) */
const uint8_t I2S_PIN_SDIN = 35;  /* ESP32 audio data input (from microphone) */
...
void setup() {
  ...
  Wire.begin(I2C_PIN_SDA, I2C_PIN_SCL, I2C_FREQ);

  Serial.println("Initializing I2S bus...");

  // Set up the pins used for audio input
  i2s.setPins(I2S_PIN_SCK, I2S_PIN_WS, I2S_PIN_SDOUT, I2S_PIN_SDIN, I2S_PIN_MCLK);
