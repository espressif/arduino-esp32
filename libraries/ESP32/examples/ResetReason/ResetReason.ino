...
void print_reset_reason(RESET_REASON reason)
{
  switch ( reason)
  {
    case POWERON_RESET          : Serial.println ("POWERON_RESET");break;          /**<1,  Vbat power on reset*/
    case SW_RESET               : Serial.println ("SW_RESET");break;               /**<3,  Software reset digital core*/
    case OWDT_RESET             : Serial.println ("OWDT_RESET");break;             /**<4,  Legacy watch dog reset digital core*/
    case DEEPSLEEP_RESET        : Serial.println ("DEEPSLEEP_RESET");break;        /**<5,  Deep Sleep reset digital core*/
    case SDIO_RESET             : Serial.println ("SDIO_RESET");break;             /**<6,  Reset by SLC module, reset digital core*/
    case TG0WDT_SYS_RESET       : Serial.println ("TG0WDT_SYS_RESET");break;       /**<7,  Timer Group0 Watch dog reset digital core*/
    case TG1WDT_SYS_RESET       : Serial.println ("TG1WDT_SYS_RESET");break;       /**<8,  Timer Group1 Watch dog reset digital core*/
    case RTCWDT_SYS_RESET       : Serial.println ("RTCWDT_SYS_RESET");break;       /**<9,  RTC Watch dog Reset digital core*/
    case INTRUSION_RESET        : Serial.println ("INTRUSION_RESET");break;        /**<10, Instrusion tested to reset CPU*/
    case TGWDT_CPU_RESET        : Serial.println ("TGWDT_CPU_RESET");break;        /**<11, Time Group reset CPU*/
    case SW_CPU_RESET           : Serial.println ("SW_CPU_RESET");break;           /**<12, Software reset CPU*/
    case RTCWDT_CPU_RESET       : Serial.println ("RTCWDT_CPU_RESET");break;       /**<13, RTC Watch dog Reset CPU*/
    case EXT_CPU_RESET          : Serial.println ("EXT_CPU_RESET");break;          /**<14, for APP CPU, reseted by PRO CPU*/
    case RTCWDT_BROWN_OUT_RESET : Serial.println ("RTCWDT_BROWN_OUT_RESET");break; /**<15, Reset when the vdd voltage is not stable*/
    case RTCWDT_RTC_RESET       : Serial.println ("RTCWDT_RTC_RESET");break;       /**<16, RTC Watch dog reset digital core and rtc module*/
