...
For long-press and multi-press gestures, see the [MatterEnhancedSmartButton](../MatterEnhancedSmartButton) example.
...
For long-press and multi-press Matter gestures, use the [MatterEnhancedSmartButton](../MatterEnhancedSmartButton) example.
...
Use a Matter-compatible hub (like a Home Assistant server, Apple HomePod, Google Nest Hub, or Amazon Echo) to commission the device. After commissioning, you can set up automations that trigger when the button is pressed.
