...
- On dual-stack ESP32-C6, Thread Network Commissioning replaces Wi-Fi on endpoint 0. ESP32-C5 Thread menu and ESP32-H2 are already Thread-only.
...
| ESP32-C5 | Thread (**Matter Network → Thread**) | On       | Wi-Fi, Ethernet (SPI)  |
