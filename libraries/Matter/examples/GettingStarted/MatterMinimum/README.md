...
| -------- | ---------------------- | -------- | ----------------------------- | -------- |
| ESP32    | Wi-Fi (SSID in sketch) | Off      | Ethernet (EMAC or SPI)        | Optional |
| ESP32-S2 | Wi-Fi (SSID in sketch) | Off      | Ethernet (SPI)                | Optional |
| ESP32-S3 | Wi-Fi (hub)            | On       | Ethernet (SPI)                | Optional |
| ESP32-C3 | Wi-Fi (hub)            | On       | Ethernet (SPI)                | Optional |
| ESP32-C5 | Wi-Fi (hub, default)   | On       | Thread (menu), Ethernet (SPI) | Optional |
| ESP32-C6 | Wi-Fi (hub, default)   | On       | Thread, Ethernet (SPI)        | Optional |
| ESP32-H2 | Thread (hub)           | On       | Ethernet (SPI)                | Optional |
