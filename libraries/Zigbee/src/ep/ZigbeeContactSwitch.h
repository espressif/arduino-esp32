...
// NOTE(zb-v2): the v2.x IasZone server config struct (ezb_zcl_ias_zone_cluster_config_t) replaces the v1
// ias_cie_addr byte array with a single uint64_t ias_cie_address and drops the zone_ctx field.
