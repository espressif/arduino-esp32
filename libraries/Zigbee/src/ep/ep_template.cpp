...
ZigbeeDevice::ZigbeeDevice(uint8_t endpoint) : Zigbee_EP(endpoint) {
    _device_id = ESP_ZB_HA_ON_OFF_LIGHT_DEVICE_ID; // Change to correct device ID

    //Change to correct config
    ...
    _ep_config = {       
        ...
        .app_device_id = ESP_ZB_HA_ON_OFF_LIGHT_DEVICE_ID, // Change to correct device ID
