...
Server side of the [UDP Light + Switch demo](../README.md). This sketch turns the
board into:
...
It is the counterpart of [`switch.ino`](../switch/switch.ino).
...
OThread.addJoiner("J01NME", nullptr, 600 /* seconds */);
...
sure to mirror the change in [`switch.ino`](../switch/switch.ino).
...
* [`../README.md`](../README.md) - High-level architecture for the
  light + switch pair.
* [`../switch/`](../switch/) - The companion client sketch.
* [`../../ThreadCommissioning/CommissionerNode/`](../../ThreadCommissioning/CommissionerNode/) -
