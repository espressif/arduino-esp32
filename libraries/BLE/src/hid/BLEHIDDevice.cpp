...
BLECharacteristic BLEHIDDevice::inputReport(uint8_t reportId) {
  return createReportChar(_hidSvc, BLEProperty::Read | BLEProperty::Notify, reportId, BLE_HID_REPORT_TYPE_INPUT);
}

BLECharacteristic BLEHIDDevice::outputReport(uint8_t reportId) {
  return createReportChar(_hidSvc, BLEProperty::Read | BLEProperty::Write | BLEProperty::WriteNR, reportId, BLE_HID_REPORT_TYPE_OUTPUT);
}

BLECharacteristic BLEHIDDevice::featureReport(uint8_t reportId) {
  return createReportChar(_hidSvc, BLEProperty::Read | BLEProperty::Write, reportId, BLE_HID_REPORT_TYPE_FEATURE);
}
