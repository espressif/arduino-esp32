 ...
 * the component's @c BLEFooImpl.h) and backend-specific members (declared in
 ...
 *   - In backend translation units (in backend translation units), prefer the macro too; a
